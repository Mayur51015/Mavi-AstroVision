...
const GoogleAuthButton = ({ label = 'Continue with Google' }) => {
  ...
  return (
    <a
      id="google-auth-btn"
      href={googleAuthUrl}
      className={`w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border font-medium text-sm transition-all duration-200 shadow-sm cursor-pointer select-none ${
        isDark
